...
export const useUser = create<IUserStore>()(devtools((set, get) => ({
    ...
    setCurrentDict: () => set({currentDict: get().currentUser.isUserDictionary ? get().currentUser.userDict : get().mainDict}, false, "currentDict"),
    ...
    clearLearningWords: () => set({learningWords: []}, false, "learningWords - clearLearningWords"),
